...
$send2 = [text.encoding]::ascii.getbytes("RELEASE_DLL--C:\SC-Stocks\Data\carlozIndis.dll") 
[void] $client.send($send2, $send2.length, $peerIP, $peerPort) 
# $client.close() 
...
# RELOAD DLL
$send2 = [text.encoding]::ascii.getbytes("ALLOW_LOAD_DLL--C:\SC-Stocks\Data\carlozIndis.dll") 
[void] $client.send($send2, $send2.length, $peerIP, $peerPort) 
